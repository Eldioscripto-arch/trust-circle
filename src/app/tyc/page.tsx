...
• Riesgo de oracle: La cobertura WLD del Fondo de Garantia usa el oracle nativo de World Chain (AionicaPriceOracle, inmutable). La cobertura AIONICO no esta disponible hasta que el token tenga liquidez en un DEX. El oracle puede fallar o retornar precio desactualizado (staleness check: 1 hora).
